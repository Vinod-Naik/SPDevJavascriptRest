...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="../SiteAssets/Scripts/REST-CURD.js"></script>
    <script type="text/javascript" src="../SiteAssets/Scripts/REST-ListManager.js"></script>
    <script type="text/javascript" src="../SiteAssets/Scripts/REST-ListItemManager.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderMain" runat="server">
  ...
  <div class="basicJSRESTContainer">
          ...
          <input type="button" id="btnRdLstItmsPgd" value="Read List Items(Paged)" />
          <input type="button" id="btnRdLstItmsCtgr" value="Read List Items ByCategory" />
          <input type="button" id="btnRdLstFlds" value="Read List Fields" />
      <br /><br />    
